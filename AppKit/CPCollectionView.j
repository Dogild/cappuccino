...
@optional
- (BOOL)collectionView:(CPCollectionView)collectionView acceptDrop:(id <NSDraggingInfo>)draggingInfo index:(CPInteger)index dropOperation:(CPCollectionViewDropOperation)dropOperation;
...
- (CPDragOperation)collectionView:(CPCollectionView)collectionView validateDrop:(id <NSDraggingInfo>)draggingInfo proposedIndex:(CPInteger)proposedDropIndex dropOperation:(CPCollectionViewDropOperation)proposedDropOperation;
...
*/
- (BOOL)_sendDelegateAcceptDrop:(id <NSDraggingInfo>)draggingInfo index:(CPInteger)index dropOperation:(CPCollectionViewDropOperation)dropOperation
{
...
*/
- (CPDragOperation)_sendDelegateValidateDrop:(id <NSDraggingInfo>)draggingInfo proposedIndex:(CPInteger)proposedDropIndex dropOperation:(CPCollectionViewDropOperation)proposedDropOperation
{
